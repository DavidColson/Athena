...
namespace An
{
    ...
    // If we're just showing the user some stuff that they can use in their level, we may not want to load everything. Assets should have a state so you can query if they're loaded or not
