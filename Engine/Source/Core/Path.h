...
namespace An
{
    ...
    public:
        ...
        struct PathIterator
        {
            PathIterator(eastl::vector<eastl::string>::const_iterator _pathPartsIter) : m_pathPartsIter(_pathPartsIter) {}
            ...
            eastl::vector<eastl::string>::const_iterator m_pathPartsIter;
        };
    ...
    protected:
        ...
        bool m_hasValidRootname{ false };
        eastl::vector<eastl::string> m_pathParts;
        eastl::string   m_stringPath;
        char m_preferredSeparator{ '/' };
    };
